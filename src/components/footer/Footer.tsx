...
const Footer = () => {
  const lists = ['home', 'blog', 'about', 'contact us', 'privacy policy'];
  ...
  return (
    <footer className={styles.footerWrapper}>
        ...
        <div className={styles.burger} onClick={toggleMenu}>
          ...
          >
            <g id='fi-rr-menu-burger'>
              <path
                id='Vector'
                d='M23 11.5H1C0.447715 11.5 0 11.9477 0 12.5C0 13.0523 0.447715 13.5 1 13.5H23C23.5523 13.5 24 13.0523 24 12.5C24 11.9477 23.5523 11.5 23 11.5Z'
                fill='white'
              />
              <path
                id='Vector_2'
                d='M23 4.5H1C0.447715 4.5 0 4.94772 0 5.5C0 6.05228 0.447715 6.5 1 6.5H23C23.5523 6.5 24 6.05228 24 5.5C24 4.94772 23.5523 4.5 23 4.5Z'
                fill='white'
              />
              <path
                id='Vector_3'
                d='M23 18.5H1C0.447715 18.5 0 18.9477 0 19.5C0 20.0523 0.447715 20.5 1 20.5H23C23.5523 20.5 24 20.0523 24 19.5C24 18.9477 23.5523 18.5 23 18.5Z'
                fill='white'
              />
            </g>
          </svg>
        ...
        {showMenu && (
          <div className={styles.menu}>
            <div className={styles.df}>
                ...
                {lists.map((list) => {
                  return (
                    <li key={list} onClick={toggleMenu}>
                      <Link
                        to={
                          list.toLocaleLowerCase() === 'home'
                            ? '/'
                            : list.toLocaleLowerCase() === 'contact us'
                              ? '/contact'
                              : list.toLocaleLowerCase() === 'privacy policy'
                                ? '/policy'
                                : `/${list}`
                        }
                      >
              ...
              <div className={styles.burger} onClick={toggleMenu}>
                <img src='/assets/fi-rr-menu-burger.svg' alt='burger menu' />
              </div>
            </div>
          </div>
        )}
      ...
      <div className={styles.footerInfo}>
        ...
        <div className={styles.footerInfoForm}>
          <MyInput
            ...
            action={action}
          />
          <MyButton onClick={onClick} buttonType={'main'}>
            Subscribe
          </MyButton>
        </div>
      </div>
